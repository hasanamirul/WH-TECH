...
<div class="master-wrapper">
    ...
    <button @click="document.getElementById('addForm').classList.add('active')" class="btn-add mb-4">Tambah Agama</button>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->nama }}</td>
                <td class="flex gap-2">
                    <a href="{{ route('master.agama.edit',$item->id) }}" class="btn-edit">Edit</a>
    ...
    <div id="addForm" class="modal">
        <div class="modal-content">
            <h3 class="mb-2 text-blue-600">Tambah Agama</h3>
